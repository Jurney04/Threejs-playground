...
function startWiggle(mesh, baseMinAmp, baseMaxAmp, baseMinDur, baseMaxDur) {
	if (mesh?.current) {
...
export function InstancedAngel({ position = [0, 0, 0], onModelLoad }) {
	...
	useEffect(() => {
		const timer = setTimeout(() => {
			onModelLoad?.();
			console.log("InstancedAngel fully initialized.");
		}, 100);
